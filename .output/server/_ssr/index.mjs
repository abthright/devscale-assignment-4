...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-hI7Y11ox.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-XwdNL2tY.mjs").then((n2) => n2.r);
